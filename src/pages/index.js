...
const IndexPage = () => {
  ...
  return (
    <Layout>
      <Seo title="Designer" />
      <motion.div
        className="relative flex flex-col items-center h-[36rem] md:h-[44rem]"
      ...
      >
        <div className="fixed">
          ...
          <h1 className="text-[1.8rem] sm:text-4xl md:text-5xl xl:text-7xl font-serif text-white text-center leading-9 md:leading-12 xl:leading-14">
